...
class Platform:
    ...
    def __init__(self,
                 ...
                 agent_num: int = 1,
                 paper_folder_path: str = "/Users/husainsaif/Desktop/Virtual-Scientists/data/papers",
                 future_paper_folder_path: str = "/Users/husainsaif/Desktop/Virtual-Scientists/data/papers_future",
                 author_info_dir: str = '/Users/husainsaif/Desktop/Virtual-Scientists/data/books',
                 adjacency_matrix_dir: str = '/Users/husainsaif/Desktop/Virtual-Scientists/data/adjacency.txt',
                 agent_model_config_name: str = 'ollama_llama3.1_8b',
                 review_model_config_name: str = 'ollama_llama3.1_8b',
